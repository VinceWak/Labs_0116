...
* **Python file** or **Excel file** containing the predictions calculations. Also you can use formulas in Tableau for the predictions..
* **A ``README.md`` file** containing a detailed explanation of the process including explanation of the dashboard development
* **A link to your Trello board** showing all the tasks that were done
* **link to the deployed version in Tableau** can be added to your readme
